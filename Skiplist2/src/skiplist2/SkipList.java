...
//	System.out.print("1 ");
  ...
  public void printHorizontal(Interface in )
  {
     String s = "";
     int i;
  ...
  public String getOneRow( SkipListEntry p ,Interface in)
  {
     String s;
     int a, b, i;
     ...
     while ( p != null )
     {
	   ...
	   q = q.down;
        ...
        System.out.println(p.key+" hi "+p.value);
 ...
 public SkipListEntry getMax()
  {     
     int max=0;
     SkipListEntry maxp=null;
